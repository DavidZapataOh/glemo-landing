...
| `--line` | `oklch(1 0 0 / 0.09)` | n/a | Hairlines on dark |
...
| `--paper-line` | `oklch(0 0 0 / 0.10)` | n/a | Hairlines on paper |
...
| `--verify-dim` | `oklch(0.82 0.155 165 / 0.12)` | n/a | Accent washes/tints |
