...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "guides/meta.json": __fd_glob_1, "concepts/meta.json": __fd_glob_2, }, {"api.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, "issue.mdx": __fd_glob_5, "quickstart.mdx": __fd_glob_6, "concepts/credentials.mdx": __fd_glob_7, "concepts/verification.mdx": __fd_glob_8, "guides/webhooks.mdx": __fd_glob_9, });