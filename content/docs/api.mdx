...
Verdict computation is sub-millisecond server-side; the latency you observe is
network. Every verification is also logged to your dashboard with its verdict
and latency.
